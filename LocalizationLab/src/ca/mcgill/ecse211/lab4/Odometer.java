...
public class Odometer extends Thread {
  // robot position
  private double x; // current x coordinate wrt the origin (intersection of the closest 2 black
                    // lines
  private double y; // current y coordinate wrt the origin (intersection of the closest 2 black
                    // lines
  ...
  private double distL, distR, deltaD, deltaTRad, deltaT, dX, dY; // used later for computing x, y,
                                                                  // and theta
  ...
  public void run() {
    ...
    while (true) {
      ...
      // computing the displacement for each wheel by calculating the difference between the old and
      // new
